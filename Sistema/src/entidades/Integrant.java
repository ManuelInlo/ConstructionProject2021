...
import java.sql.Date; //Tambien existe la libreria java.util.Date
...
public class Integrant {
    ...
    public Integrant(String curp, String role, String nameIntegrant, String studyDegree, String studyDicipline, String prodepParticipation, String typeTeaching, String eisStudyDegree, String institucionalMail, String numberPhone, Date dateBirthday) {
        this.curp = curp;
        this.role = role;
